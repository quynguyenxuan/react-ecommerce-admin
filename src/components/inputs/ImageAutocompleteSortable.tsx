...
export type ImageAutoCompleteSortableProps = ChoicesInputProps<TextFieldProps & Options> &
...
export const ImageAutoCompleteSortable: FunctionComponent<ImageAutoCompleteSortableProps> = (props: any) => {
  const {
    label,
    format,
    helperText,
  ...
  const selectedValues = selectedItems.map((item: any) => choices[item]);
  console.log(
